const Navbar = () => {
  return (
    <>
      <header className="fixed top-0 z-50 w-full bg-white p-4 shadow-xl dark:text-gray-100">
        <div className="container mx-auto flex h-16 justify-between">
          ...
          <div className="flex items-center md:space-x-4">
            ...
            <button
              type="button"
              className="hidden rounded px-6 py-2 font-semibold dark:bg-violet-400 dark:text-gray-900 lg:block"
            >
              Log in
            </button>
          </div>
