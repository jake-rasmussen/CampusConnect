      ...
      >
        <div className="absolute inset-0 overflow-hidden">
          <div
            ...
            invert
            filter
            will-change-transform [--aurora:repeating-linear-gradient(100deg,var(--blue-500)_100%,var(--indigo-300)_15%,var(--blue-300)_75%,var(--violet-200)_25%,var(--blue-400)_75%)] [--dark-gradient:repeating-linear-gradient(100deg,var(--black)_0%,var(--black)_7%,var(--transparent)_10%,var(--transparent)_12%,var(--black)_16%)] [--white-gradient:repeating-linear-gradient(100deg,var(--white)_0%,var(--white)_7%,var(--transparent)_10%,var(--transparent)_6%,var(--white)_16%)]
